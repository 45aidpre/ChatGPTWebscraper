...
class InvalidTests:
    ...
    def invalid_test_1(self):
        ...
        assert responseString == "help" or "problem"

    def invalid_test_all(self):
        """
    ...
    def invalid_messages(self):
        ...
        assert responseString == "problem" or "issue"
        ...
        assert responseString == "I like soup"
        ...
        assert responseString == "O.J. Simpson is Innocent."
        ...
        assert responseString == "The potential hazards associated with microplastics come in three forms: physical particles, chemicals and microbial pathogens as part of biofilms."
